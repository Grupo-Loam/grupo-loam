      ...
      <main className="w-full bg-[#F3F0E8]">
        ...
        <section className="flex w-full justify-center bg-[var(--bg-secondary)]">
          <div className="flex w-full max-w-[1100px] flex-col items-center px-6 py-20 text-center sm:px-8 md:py-24 lg:px-10 lg:py-28">
            ...
            <h1 className="mt-7 max-w-[850px] text-center font-[var(--font-cinzel)] text-[30px] font-medium leading-[1.2] text-[var(--color-carbon)] sm:text-[36px] md:text-[42px] lg:text-[44px]">
              LOAM Grupo Empresarial
            </h1>

            <div className="mt-8 h-px w-16 bg-[var(--color-bronce)]" />

            <p className="mt-10 max-w-[820px] text-center text-[15px] leading-8 text-[#514D47] sm:text-[16px] md:text-[17px] md:leading-9">
        ...
        <div className="h-10 w-full bg-[#F3F0E8] md:h-14 lg:h-16" />
        ...
        <section className="flex w-full justify-center bg-[var(--bg-primary)]">
          <div className="flex w-full max-w-[1100px] flex-col items-center px-6 py-20 text-center sm:px-8 md:py-24 lg:px-10 lg:py-28">
            ...
            <p className="mt-12 max-w-[850px] text-center text-[15px] leading-8 text-[#514D47] sm:text-[16px] md:text-[17px] md:leading-9">
        ...
        ======================================== */}
        <section className="flex w-full justify-center bg-[var(--bg-primary)]">
          <div className="flex w-full max-w-[1320px] flex-col items-center px-6 py-20 text-center sm:px-8 md:py-24 lg:px-10 lg:py-28">
            {/* TÍTULO */}
            ...
            {/* CARDS */}
            <div className="mt-16 grid w-full gap-7 sm:grid-cols-2 lg:grid-cols-4">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <div className="flex min-h-[210px] flex-col px-6 py-7">
                    ...
                    <h3 className="mt-4 font-[var(--font-cinzel)] text-[17px] uppercase leading-7 tracking-[0.03em] text-[#1D1D1B] sm:text-[18px]">
                      {value.title}
                    </h3>

                    <div className="my-4 h-px w-10 bg-[var(--color-bronce)] transition-all duration-500 group-hover:w-16" />

                    <p className="text-[14px] leading-7 text-[#45413C] sm:text-[15px]">
                      {value.description}
                    </p>
                  </div>
                </article>
        ...
        {/* ESPACIO ENTRE VALORES Y FILOSOFÍA */}
        <div className="h-10 w-full bg-[#F3F0E8] md:h-14 lg:h-16" />
        ...
        <section className="flex w-full justify-center bg-[#EAE6DD]">
          <div className="flex w-full max-w-[1100px] flex-col items-center px-6 py-20 text-center sm:px-8 md:py-24 lg:px-10 lg:py-28">
            ...
            <h3 className="mt-14 max-w-[850px] text-center font-[var(--font-cinzel)] text-[30px] leading-tight text-[var(--color-carbon)] sm:text-[38px] md:text-[42px]">
              Construimos. Operamos. Crecemos.
            </h3>

            <p className="mt-7 max-w-[700px] text-center font-[var(--font-cinzel)] text-[17px] text-[#5D5852] sm:text-[20px]">
